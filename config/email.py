...
注册邮箱与 OTP 均只走 Outlook 账号池：
    ...
    3. 运行注册时会自动导入新增邮箱
"""
from config.env_loader import env_str, env_int, apply_env_overrides
...
#   "icloud_api"        — iCloud Pickup 邮箱池（邮箱 + 专属 Token）
...
# iCloud Mail Search 浏览器资料接口。站点迁移或管理员轮换单邮箱
