...
# 优先按价格和库存选择的国家代码；留空时回退到 SMS_COUNTRY
SMS_PREFERRED_COUNTRIES: list[str] = []

# 同一国家连续失败多少次后切换下一个优选国家
